        ...
        pub mod $mod_name {
            ...
            pub mod keys {
                ...
                $(
                    ...
                    pub const $mthd: postcard_schema::key::Key = $crate::traits::endpoint_key2::<$req_ty, $resp_ty>(stringify!($mthd));
                )*
            ...
            pub trait Server {
                ...
                fn process_one<'buf>(
                    ...
                    $(
                        const _: () = $crate::traits::assert_impls_schema::<$req_ty>();
                        const _: () = $crate::traits::assert_impl_deserialize::<'_, $req_ty>();
                    )*
                    ...
                    $(
                        const _: () = $crate::traits::assert_impls_schema::<$resp_ty>();
                        const _: () = $crate::traits::assert_impl_serialize::<$resp_ty>();
                    )*

                    // This block ensures that there are no key collisions in all endpoints
                    const _: () = $crate::traits::assert_unique(keys::ALL_KEYS);
                    ...
                    match hdr.key {
                        $(
                            keys::$mthd => $crate::traits::process::<
                                Self,
                                $req_ty,
                                $resp_ty,
